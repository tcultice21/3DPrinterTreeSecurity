...
static __inline unsigned int subtract(digit_t* a, digit_t* b, digit_t* c, unsigned int nwords)
...
static void Montgomery_multiply(digit256_t ma, digit256_t mb, digit256_t mc, digit256_t modulus)
...
static __inline void v2div1271(uint32_t* a) 
